...
export const affinityToolMappings: AffinityToolMapping[] = [
  ...
  {
    source: "listUpcomingDates",
    tool: reviewAffinityToolName,
    view: "dates.upcoming",
  },
  {
    source: "getAffinityChart",
    tool: reviewAffinityToolName,
    view: "graph.chart",
  },
  {
    source: "getMergeHistory",
    tool: reviewAffinityToolName,
    view: "merges.history",
  },
  ...
  {
    source: "dismissDuplicate",
    tool: manageDuplicateDismissalToolName,
    action: "dismiss",
  },
  {
    source: "undismissDuplicate",
    tool: manageDuplicateDismissalToolName,
    action: "undismiss",
  },
  {
    source: "listDismissedDuplicates",
    tool: reviewAffinityToolName,
    view: "merges.dismissed",
  },
  ...
  {
    source: "recordInteraction",
    tool: recordEventToolName,
    action: "interaction",
  },
  {
  ...
  {
    source: "recordTransaction",
    tool: recordEventToolName,
    action: "transaction",
  },
  {
    source: "recordCommitment",
    tool: manageCommitmentToolName,
    action: "record",
  },
  {
    source: "resolveCommitment",
    tool: manageCommitmentToolName,
    action: "resolve",
  },
  { source: "addDateAnchor", tool: manageDateAnchorToolName, action: "add" },
  {
    source: "reviseDateAnchor",
    tool: manageDateAnchorToolName,
    action: "revise",
  },
  {
    source: "removeDateAnchor",
    tool: manageDateAnchorToolName,
    action: "remove",
  },
  ...
  {
    source: "replaceAttributes",
    tool: manageAttributeToolName,
    action: "replace",
  },
];
